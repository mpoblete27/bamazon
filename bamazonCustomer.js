...
function start(){
    ...
    connection.query('SELECT * FROM Products', function(err, res){
      ...
      for(var i = 0; i<res.length;i++){
        console.log("ID: " + res[i].ItemID + " | " + "Product: " + res[i].product_name + " | " + "Department: " + res[i].department_name + " | " + "Price: " + res[i].price + " | " + "QTY: " + res[i].stock);
        console.log('--------------------------------------------------------------------------------------------------')
      }
        ...
        },
        {
          ...
          if(res[whatToBuy].stock >= howMuchToBuy){
            ...
            {ItemID: ans.id}
                ...
                if(err) throw err;
                console.log("Success! We hope you enjoy your purchase!");
